...
日期：2026-08-15
状态：已发版 v0.47.0（CI 八拍 mock 已过；真机 §8.2 未跑，不得宣称三症状已修复）
...
- 本地模型连接 60s×2。
- 真机 8 次幕前续写（§8.2）——P3 只提供清单与 mock。

## 13. 验收声明

P0–P2 以 §10 契约测试为「可上线」门槛。P3 mock 为设计验收探针的 CI 替代。真机 §8.2 未跑前，文档必须写「三症状不得宣称已修复」。
