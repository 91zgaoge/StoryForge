...
# StoryForge (草苔) v4.5.0 - AI 导演式小说创作系统
...
>
> **v4.5.0 最新更新**：多账号认证与云端主站 — 从单机创作到云端生态。新增 Google/GitHub OAuth2 多账号登录（可选登录，本地优先），不登录可正常使用所有功能，登录后解锁未来云同步能力。新增 Linux 服务端主站（Actix-web + PostgreSQL + Docker），包含落地页、Web 登录、用户后台，支持 Docker Compose 一键部署。微信/QQ 登录预留框架。
>
