...
> 最后更新: 2026-08-15（v0.46.0 传统色主题：纸帘印 + 幕前幕后分选）

## ✅ v0.27.x–v0.46.x 已实施完成
...
- **真机验收与学习飞轮调优**：三代理创世/续写的真机盲测；**尚未跑设计 §13 连续 8 次幕前续写真机探针**（需 LLM），未通过前不得宣称四症状已修复；质量门阈值与 grader 权重校准；持续学习双轨（观察 → instinct → 晋升技能）的置信度参数与晋升质量跟踪。
